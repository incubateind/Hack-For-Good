...
public class MapsActivity111 extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps111);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mDatabaseReference1 = FirebaseDatabase.getInstance().getReference("lat");
        ...
        mDatabaseReference1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Log.d("lat1", a1.toString());

                LatLng sydney16 = new LatLng(a1, 79.521358);
        ...
        double[] x= new double[]{28.5672,21.1534, 18.984028};
        double[] y=new double[]{77.2100,21.1534, 18.984028};



//        Marker[] markerName1= new Marker[3];
//
//        for(int i=0; i<3; i++)
//        {
//            LatLng sydney = new LatLng(x[i], y[i]);
//            markerName1[i]=mMap.addMarker(new MarkerOptions().position(sydney).title("Title"));
//        }
...
//11.758  79.76
    ...
    public void onLocationChanged(Location location) {
        ...
        Toast.makeText(MapsActivity111.this,"Your Current Location", Toast.LENGTH_LONG).show();
