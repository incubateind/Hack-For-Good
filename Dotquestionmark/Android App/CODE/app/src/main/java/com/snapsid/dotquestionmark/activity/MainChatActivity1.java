...
public class MainChatActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_chat1);
        ...
        go.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mAdapter =new ChatListAdapter1(MainChatActivity1.this, mDatabaseReference, mDisplayName, disS);
        ...
        re.setOnClickListener(new View.OnClickListener() {
            ...
            Intent intent=new Intent(getApplicationContext(), RequestFood1.class);
...
//        }
    ...
    public void onStart(){
        super.onStart();
        mAdapter =new ChatListAdapter1(this, mDatabaseReference, mDisplayName, disS);
        mChatListView.setAdapter(mAdapter);
    }
    @Override
    public void onStop() {
