...
import com.snapsid.dotquestionmark.activity.ShowPlacesOnMapActivity;
import com.snapsid.dotquestionmark.adapter.PlaceRecyclerViewAdapter;
import com.snapsid.dotquestionmark.constants.PlacesConstant;
...
public class NearByFragment extends Fragment {
    ...
    private String buildUrl(double latitude, double longitude, String API_KEY) {
        ...
        //Log.d("urlcheck", urlString.toString());
    ...
    private void getNearbyPlaces() {
        ...
        if (lat != 0 && lng != 0) {
            ...
            String apiKey = getContext().getResources().getString(R.string.google_api_key1);
