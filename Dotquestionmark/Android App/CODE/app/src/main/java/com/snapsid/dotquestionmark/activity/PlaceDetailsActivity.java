...
import com.snapsid.dotquestionmark.models.Photos;
import com.snapsid.dotquestionmark.models.Results;
...
public class PlaceDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (results.getInternational_phone_number() != null) {
            //linearLayoutRating.setVisibility(View.VISIBLE);
           // textViewRating.setText(results.getRating());
            //ratingBar.setRating(Float.valueOf(results.getRating()));

            Log.d("sidd", results.getInternational_phone_number());

            phone.setText(results.getInternational_phone_number());
