...
import com.snapsid.dotquestionmark.Adapters.StateAdapter;
import com.snapsid.dotquestionmark.models.History;
import com.snapsid.dotquestionmark.models.HistoryModel;
import com.snapsid.dotquestionmark.models.NewApiModels.ModelAPI;
import com.snapsid.dotquestionmark.models.NewApiModels.States;
import com.snapsid.dotquestionmark.models.Statewise;
import com.snapsid.dotquestionmark.Utils.Helper;
import com.snapsid.dotquestionmark.Utils.URLS;
import com.snapsid.dotquestionmark.Utils.VolleySingleton;
...
public class NewCurrent extends AppCompatActivity implements StateAdapter.setOnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_current);
        ...
        otherCountry=(Button) findViewById(R.id.otherid);
        otherCountry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(), Corona.class);
